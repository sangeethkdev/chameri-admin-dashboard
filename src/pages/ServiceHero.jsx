...
const ServiceHero = () => {
  ...
  useEffect(() => {
    ...
    setSubheading(data?.heroSection?.subheading || "");
  ...
  const heroMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(err.response?.data?.message || "Failed to save Services Hero section"),
  });
  ...
  return (
    <div className="space-y-6 max-w-4xl pb-10">
      ...
      <div className="bg-dark-800 p-6 rounded-3xl mb-6 shadow-sm border border-surface-border">
        <h1 className="text-2xl font-bold text-white">Services — Hero Section</h1>
        <p className="text-gray-400 text-sm mt-1">
          Manage the hero video, heading and subheading for the Services page.
        </p>
      </div>
