  ...
  return (
    <div className="space-y-6 max-w-5xl pb-10">
      <div className="bg-dark-800 p-6 rounded-3xl mb-6 shadow-sm border border-surface-border">
        <h1 className="text-2xl font-bold text-white">Kiwano Villament — Features Section</h1>
        <p className="text-gray-400 text-sm mt-1">Manage the features list for the Kiwano Villament page.</p>
      </div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
          ...
          <InputField label="Subheading" value={featureSubheading} onChange={e => setFeatureSubheading(e.target.value)} placeholder="e.g. What makes Kiwano Villament special" />
        </div>
...
export default KiwanoVFeatures;
