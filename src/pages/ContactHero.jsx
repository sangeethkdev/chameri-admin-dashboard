  ...
  const heroMutation = useMutation({
    mutationFn: async () => {
      ...
      const image = newImage
        ...
        : existingImage;
      const mobileImage = newMobileImage
        ? (await uploadToCloudinary(newMobileImage, { folder: "chameri/contact" })).url
        : existingMobileImage;

      return api.put("/contact-main/main/hero", { heading, image, mobileImage });
    },
    onSuccess: () => {
      heroFlash.flash();
      setNewImage(null);
