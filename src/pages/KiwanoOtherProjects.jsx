  ...
  return (
    <div className="space-y-6 max-w-4xl pb-10">
      <div className="bg-dark-800 p-6 rounded-3xl mb-6 shadow-sm border border-surface-border">
        <h1 className="text-2xl font-bold text-white">Kiwano — Other Projects</h1>
        ...
        <div className="grid grid-cols-1 gap-5">
          ...
          <div className="pt-2 border-t border-gray-100 space-y-5">
            ...
            <InputField
              ...
              placeholder="e.g. Kiwano Villaments"
            />
            <TextareaField
...
export default KiwanoOtherProjects;
